def ejer1():
    ...
    while valor <=0:
        valor = int(input("Error. Ingrese el numero de la tabla: "))
...
def ejer2():
    ...
    print("\nGracias por utilizar el sistema.Precione enter para salir.")
   
def ejer3():
    f = int(input("Ingrese la cantidad de filas: "))
    c = int(input("Ingrese la cantidad de coloumnas: "))
